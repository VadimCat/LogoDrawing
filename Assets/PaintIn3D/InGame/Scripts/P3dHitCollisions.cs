...
namespace PaintIn3D
{
    ...
    public class P3dHitCollisions : MonoBehaviour
    {
        ...
        [FSA("draw")] [SerializeField] private EmitType emit;
        ...
        public float RaycastDistance { set { raycastDistance = value; } get { return raycastDistance; } }
        [SerializeField] private float raycastDistance = 0.0001f;
        ...
        public bool OnlyUseFirstContact { set { onlyUseFirstContact = value; } get { return onlyUseFirstContact; } }
        [SerializeField] private bool onlyUseFirstContact = true;
        ...
        public PressureType PressureMode { set { pressureMode = value; } get { return pressureMode; } }
        [SerializeField] private PressureType pressureMode = PressureType.ImpactSpeed;

        /// <summary>The impact strength required for a hit to occur with a pressure of 0.</summary>
        public float PressureMin { set { pressureMin = value; } get { return pressureMin; } }
        [FSA("impactMin")] [SerializeField] private float pressureMin = 50.0f;

        /// <summary>The impact strength required for a hit to occur with a pressure of 1.</summary>
        public float PressureMax { set { pressureMax = value; } get { return pressureMax; } }
        [FSA("impactPressure")] [SerializeField] private float pressureMax = 100.0f;

        /// <summary>The pressure value used when <b>PressureMode</b> is set to <b>Constant</b>.</summary>
        public float PressureConstant { set { pressureConstant = value; } get { return pressureConstant; } }
        [SerializeField] [Range(0.0f, 1.0f)] private float pressureConstant = 1.0f;
        ...
        [FSA("pressure")] [SerializeField] private float pressureMultiplier = 1.0f;
        ...
        public GameObject Root { set { ClearHitCache(); root = value; } get { return root; } }
